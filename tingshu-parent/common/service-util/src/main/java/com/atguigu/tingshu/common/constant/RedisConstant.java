...
public class RedisConstant {
    ...
    public static final int USER_LOGIN_KEY_TIMEOUT = 60 * 60 * 24 * 14;
    public static final int USER_LOGIN_REFRESH_KEY_TIMEOUT = 60 * 60 * 24 * 365;

    /**
     * 用户信息缓存前缀
     * <p>
     * ⚠️ 三处必须一致：本常量 / UserInfoServiceImpl 上 @GuiGuCache 的 prefix / CDC UserListener 删除的 key。
     * 需要改前缀时只改这里，不要在别处硬编码。
     */
    public static final String USER_INFO_PREFIX = "user:userinfovo:";
    ...
    //专辑统计前缀
    public static final String ALBUM_STAT_PREFIX = "album:stat:";
}
